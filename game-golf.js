...
/*JP - 7/14/2020: Added for Versa 2 support*/  
  if(device.modelName == "Versa 2" || device.modelName == "Versa Lite"){
    document.getElementById("svh0").height = 100;
    document.getElementById("btnPreviousHole").style.display = "inline";
    document.getElementById("btnNextHole").style.display = "inline";
    document.getElementById("headerLine").y1 = 100;
    document.getElementById("headerLine").y2 = 100;
  }
...
/*JP - 7/14/2020: Added for Versa 2 support*/
  document.getElementById("btnPreviousHole").onclick = function() { changeHole(srnGame, gameState, -1) };
  document.getElementById("btnNextHole").onclick = function() { changeHole(srnGame, gameState, 1) };
